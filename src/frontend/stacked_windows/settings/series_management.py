...
class SeriesManagementSettings(BaseSettings):
    ...
    def __init__(self, config, main_window, parent) -> None:
        ...
        self.rename_check_box.setToolTip(
            "Will use the existing file names if renaming is disabled"
        )
    ...
    def _update_example(
        ...
        format_str = TokenReplacer(
            media_input=Path(EXAMPLE_FILE_NAME_1),
            jinja_engine=None,
            source_file=None,
    ...
    def _show_example_input_data(self) -> None:
        ...
        example_fn.setText(EXAMPLE_FILE_NAME_1)
