...
Deliberately separate from `nfoforge/config/migrations.py`, which migrates the
...
from nfoforge.backend.utils.file_utilities import file_bytes_to_str, get_dir_size
...
from nfoforge.plugins.loader import declared_identity, declared_plugins
