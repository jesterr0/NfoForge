...
from nfoforge.exceptions import MkbrrTorrentError, ProcessError
from nfoforge.logger.nfo_forge_logger import LOG
from nfoforge.payloads.trackers import TorrentLeechInfo, TrackerInfo
from nfoforge.utils.announce_url import ensure_torrentleech_announce_url
from nfoforge.version import __version__, program_name
...
def generate_torrent(
    ...
    have produced (see `nfoforge/backend/torrents/piece_size.py`).
    """
    torrent = Torrent(
        path=path,
        private=True,
