...
from nfoforge.backend.tokens import FileToken, NfoToken, TokenData, Tokens, TokenType
from nfoforge.backend.utils.anime import is_anime_release
from nfoforge.backend.utils.audio_channels import ParseAudioChannels
from nfoforge.backend.utils.audio_codecs import AudioCodecs
from nfoforge.backend.utils.episode_matching import shared_span_title
from nfoforge.backend.utils.guessit_helpers import get_guessit_title
from nfoforge.backend.utils.language import (
...
from nfoforge.backend.utils.streaming_services import abbreviate_streaming_service
from nfoforge.backend.utils.tvdb_episodes import tvdb_episode_list
from nfoforge.backend.utils.working_dir import asset_root
from nfoforge.config.models import DynamicRangeSettings, HdrType, ResolutionKey
...
from nfoforge.enums.token_replacer import (
    ColonReplace,
    SharedWithType,
    UnfilledTokenRemoval,
)
from nfoforge.exceptions import GuessitParsingError, InvalidTokenError
...
from nfoforge.payloads.series import format_multi_season_range
from nfoforge.plugins.api import FlatFilter
from nfoforge.version import __version__, program_name, program_url
...
class TokenReplacer:
    ...
    def _cut(self, token_data: TokenData) -> str:
        ...
        Plugin-contributed entries (nfoforge.plugins.api.CustomEditionContribution)
