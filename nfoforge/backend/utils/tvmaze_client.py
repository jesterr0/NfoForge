...
# built here rather than imported from nfoforge.backend.trackers.utils: this module
# is a metadata provider, and importing the trackers package from
# nfoforge.backend.utils would invert the dependency (the TL uploader imports this).
TVMAZE_HEADERS = {
