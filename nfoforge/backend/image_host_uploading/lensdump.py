...
from nfoforge.backend.image_host_uploading.api_key_upload import api_key_image_upload
...
class LensdumpUploader(BaseImageHostUploader):
    """Uploader for Lensdump."""
    ...
    async def upload(self, request: ImageUploadRequest) -> dict[int, ImageUploadData]:
        """Upload images to Lensdump."""
        return (
            await lensdump_upload(
