...
from nfoforge.config.profiles import unique_working_dirs
...
# `_image_upload_from_to_to_dict` in `nfoforge/backend/jobs/codec.py`, which is why
...
class LoadJobDialog(QDialog):
    ...
    def _tracker_display_name(raw_name: object) -> str:
        ...
        uses everywhere -- see `nfoforge/backend/jobs/codec.py`. That is not the
