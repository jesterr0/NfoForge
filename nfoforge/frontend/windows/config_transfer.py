...
A thin layer over `nfoforge.config.transfer`, which holds every rule about what may
...
class TransferSummaryDialog(QDialog):
    ...
    The text comes from `nfoforge.config.transfer` so that this window and anything
