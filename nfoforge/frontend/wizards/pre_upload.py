...
from nfoforge.frontend.custom_widgets.pre_upload_widgets.encode_logs import (
    EncodeLogsSection,
)
from nfoforge.frontend.custom_widgets.pre_upload_widgets.nfo_template import (
    NfoTemplateSection,
)
from nfoforge.frontend.custom_widgets.pre_upload_widgets.release_notes import (
    ReleaseNotesSection,
)
